<template>
  <div>
            ...
            <div class="uk-container">
                <div class="uk-grid uk-grid-small uk-flex uk-flex-middle" uk-grid>
                    ...
                    <div class="uk-width-1-2 uk-width-1-5@m uk-visible@m">
                        <span class="uk-text-primary" uk-icon="icon:calendar; ratio: 0.8"></span><span
                            class="uk-text-small uk-text-muted uk-text-bottom"> Member since:</span><br>
                        <span class="uk-text-large uk-text-primary">13th May 2015</span>
                    </div>
                    <div class="uk-width-1-2 uk-width-1-5@m uk-visible@m">
                        <span class="uk-text-success" uk-icon="icon:user; ratio: 0.8"></span><span
                            class="uk-text-small uk-text-muted  uk-text-bottom"> Last Login:</span><br>
        ...
        <section class="uk-section uk-section-muted">
            <div class="uk-container">
                <div class="uk-grid uk-grid-medium uk-child-width-1-2 uk-child-width-1-3@m uk-grid-match" uk-lightbox
                     uk-grid
                     uk-scrollspy="target: > div > .uk-card; cls: uk-animation-slide-bottom-small uk-hidden; delay: 150">
                        ...
                        <div class="uk-card uk-card-default uk-card-small uk-hidden">
                            <div class="uk-card-media-top">
                                <div class="uk-inline-clip uk-transition-toggle uk-light">
                                    ...
                                    <a href="https://static.photocdn.pt/images/articles/2017/04/28/iStock-516651882.jpg"
                                ...
                                <div class="uk-grid-small uk-flex uk-flex-middle" uk-grid>
                                    <div class="uk-width-auto">
                                        <img class="uk-border-circle" width="70" height="70"
                                             src="https://unsplash.it/70/70/?random">
                                    </div>
                                    <div class="uk-width-expand">
                                        <h5 class="uk-margin-remove-bottom">Vivamus hendrerit tristique</h5>
